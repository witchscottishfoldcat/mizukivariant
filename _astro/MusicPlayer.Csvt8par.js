...
button.bg-\\[var\\(--primary\\)\\] {
    ...
    border: none;
}</style>`,1);function Ei(c,n){Xa(n,!1);let w=xt.mode??"meting",k=xt.meting_api??"https://www.bilibili.uno/api?server=:server&type=:type&id=:id&auth=:auth&r=:r",T=xt.id??"14164869977",A=xt.server??"netease",$=xt.type??"playlist",x=F(!1),B=F(!1),d=F(!1),b=F(!1),P=F(0),E=F(0),M=F(.7),S=F(!1),u=F(!1),j=F(!1),g=F(0),et=F(""),at=F(!1),I=F({title:"示例歌曲",artist:"示例艺术家",cover:"/favicon/favicon-light-192.png",url:"",duration:0}),p=F([]),y=F(0),a=F(),J=F(),U=F();const Ie=[{id:1,title:"ひとり上手",artist:"Kaya",cover:"assets/music/cover/hitori.jpg",url:"assets/music/url/hitori.mp3",duration:240},{id:2,title:"眩耀夜行",artist:"スリーズブーケ",cover:"assets/music/cover/xryx.jpg",url:"assets/music/url/xryx.mp3",duration:180},{id:3,title:"春雷の頃",artist:"22/7",cover:"assets/music/cover/cl.jpg",url:"assets/music/url/cl.mp3",duration:200}];async function Re(){if(!k||!T)return;l(u,!0);const s=k.replace(":server",A).replace(":type",$).replace(":id",T).replace(":auth","").replace(":r",Date.now().toString());try{const D=await fetch(s);if(!D.ok)throw new Error("meting api error");const X=await D.json();l(p,X.map(W=>{let ft=W.name??W.title??"未知歌曲",Ft=W.artist??W.author??"未知艺术家",R=W.duration??0;return R>1e4&&(R=Math.floor(R/1e3)),(!Number.isFinite(R)||R<=0)&&(R=0),{id:W.id,title:ft,artist:Ft,cover:W.pic??"",url:W.url??"",duration:R}})),t(p).length>0&&It(t(p)[0]),l(u,!1)}catch{Et("Meting 歌单获取失败"),l(u,!1)}}function We(){!t(a)||!t(I).url||(t(x)?t(a).pause():t(a).play())}function yt(){l(B,!t(B)),t(B)&&(l(b,!1),l(d,!1))}function _t(){l(d,!t(d)),t(d)&&(l(B,!1),l(b,!1))}function ie(){l(b,!t(b))}function Ne(){l(j,!t(j))}function Ye(){l(g,(t(g)+1)%3)}function qe(){if(t(p).length<=1)return;const s=t(y)>0?t(y)-1:t(p).length-1;wt(s)}function $t(){if(t(p).length<=1)return;let s;if(t(j))do s=Math.floor(Math.random()*t(p).length);while(s===t(y)&&t(p).length>1);else s=t(y)<t(p).length-1?t(y)+1:0;wt(s)}function wt(s){if(s<0||s>=t(p).length)return;const D=t(x);l(y,s),t(a)&&t(a).pause(),It(t(p)[t(y)]),(D||!t(x))&&setTimeout(()=>{t(a)&&(t(a).readyState>=2?t(a).play().catch(()=>{}):t(a).addEventListener("canplay",()=>{t(a).play().catch(()=>{})},{once:!0}))},100)}function kt(s){return s.startsWith("http://")||s.startsWith("https://")||s.startsWith("/")?s:`/${s}`}function It(s){!s||!t(a)||(l(I,{...s}),s.url?(l(u,!0),t(a).pause(),K(a,t(a).currentTime=0),l(P,0),l(E,s.duration??0),t(a).removeEventListener("loadeddata",re),t(a).removeEventListener("error",ne),t(a).removeEventListener("loadstart",se),t(a).addEventListener("loadeddata",re,{once:!0}),t(a).addEventListener("error",ne,{once:!0}),t(a).addEventListener("loadstart",se,{once:!0}),K(a,t(a).src=kt(s.url)),t(a).load()):l(u,!1))}function re(){l(u,!1),t(a)?.duration&&t(a).duration>1&&(l(E,Math.floor(t(a).duration)),t(p)[t(y)]&&K(p,t(p)[t(y)].duration=t(E)),K(I,t(I).duration=t(E)))}function ne(s){l(u,!1),Et(`无法播放 "${t(I).title}"，正在尝试下一首...`),t(p).length>1?setTimeout(()=>$t(),1e3):Et("播放列表中没有可用的歌曲")}function se(){}function Et(s){l(et,s),l(at,!0),setTimeout(()=>{l(at,!1)},3e3)}function Oe(){l(at,!1)}function Ke(s){if(!t(a)||!t(J))return;const D=t(J).getBoundingClientRect(),W=(s.clientX-D.left)/D.width*t(E);K(a,t(a).currentTime=W),l(P,W)}function Ue(s){if(!t(a)||!t(U))return;const D=t(U).getBoundingClientRect(),X=Math.max(0,Math.min(1,(s.clientX-D.left)/D.width));l(M,X),K(a,t(a).volume=t(M)),l(S,t(M)===0)}function oe(){t(a)&&(l(S,!t(S)),K(a,t(a).muted=t(S)))}function le(s){if(!Number.isFinite(s)||s<0)return"0:00";const D=Math.floor(s/60),X=Math.floor(s%60);return`${D}:${X.toString().padStart(2,"0")}`}function Xe(){t(a)&&(t(a).addEventListener("play",()=>{l(x,!0)}),t(a).addEventListener("pause",()=>{l(x,!1)}),t(a).addEventListener("timeupdate",()=>{l(P,t(a).currentTime)}),t(a).addEventListener("ended",()=>{t(g)===1?(K(a,t(a).currentTime=0),t(a).play().catch(()=>{})):t(g)===2||t(y)<t(p).length-1||t(j)?$t():l(x,!1)}),t(a).addEventListener("error",s=>{l(u,!1)}),t(a).addEventListener("stalled",()=>{}),t(a).addEventListener("waiting",()=>{}))}Da(()=>{l(a,new Audio),K(a,t(a).volume=t(M)),Xe(),w==="meting"?Re():(l(p,[...Ie]),t(p).length>0?It(t(p)[0]):Et("本地播放列表为空"))}),Pa(()=>{t(a)&&(t(a).pause(),K(a,t(a).src=""))}),za();var ue=nt(),He=tt(ue);{var Ge=s=>{var D=vi(),X=tt(D);{var W=e=>{var m=oi(),_=r(m),C=r(_);f(C,{icon:"material-symbols:error",class:"text-xl flex-shrink-0"});var L=v(C,2),o=r(L,!0);i(L);var H=v(L,2),ct=r(H);f(ct,{icon:"material-symbols:close",class:"text-lg"}),i(H),i(_),i(m),Pt(()=>V(o,t(et))),h("click",H,Oe),Y(e,m)};z(X,e=>{t(at)&&e(W)})}var ft=v(X,2);let Ft;var R=r(ft);let ce;var Ve=r(R);{var Ze=e=>{f(e,{icon:"eos-icons:loading",class:"text-white text-lg"})},Je=e=>{var m=nt(),_=tt(m);{var C=o=>{var H=li();Y(o,H)},L=o=>{f(o,{icon:"material-symbols:music-note",class:"text-white text-lg"})};z(_,o=>{t(x)?o(C):o(L,!1)},!0)}Y(e,m)};z(Ve,e=>{t(u)?e(Ze):e(Je,!1)})}i(R);var st=v(R,2);let de;var ve=r(st),Rt=r(ve),Wt=r(Rt);let fe;var pe=v(Wt,2),Qe=r(pe);{var ta=e=>{f(e,{icon:"eos-icons:loading",class:"text-white text-xl"})},ea=e=>{var m=nt(),_=tt(m);{var C=o=>{f(o,{icon:"material-symbols:pause",class:"text-white text-xl"})},L=o=>{f(o,{icon:"material-symbols:play-arrow",class:"text-white text-xl"})};z(_,o=>{t(x)?o(C):o(L,!1)},!0)}Y(e,m)};z(Qe,e=>{t(u)?e(ta):e(ea,!1)})}i(pe),i(Rt);var Nt=v(Rt,2),Yt=r(Nt),aa=r(Yt,!0);i(Yt);var me=v(Yt,2),ia=r(me,!0);i(me),i(Nt);var be=v(Nt,2),At=r(be),ra=r(At);f(ra,{icon:"material-symbols:visibility-off",class:"text-lg"}),i(At);var qt=v(At,2),na=r(qt);f(na,{icon:"material-symbols:expand-less",class:"text-lg"}),i(qt),i(be),i(ve),i(st);var Ct=v(st,2);let ge;var Ot=r(Ct),Kt=r(Ot),he=r(Kt);let xe;i(Kt);var Ut=v(Kt,2),Xt=r(Ut),sa=r(Xt,!0);i(Xt);var Ht=v(Xt,2),oa=r(Ht,!0);i(Ht);var ye=v(Ht,2),la=r(ye);i(ye),i(Ut);var _e=v(Ut,2),Bt=r(_e),ua=r(Bt);f(ua,{icon:"material-symbols:visibility-off",class:"text-lg"}),i(Bt);var Gt=v(Bt,2),ca=r(Gt);f(ca,{icon:"material-symbols:expand-more",class:"text-lg"}),i(Gt),i(_e),i(Ot);var Vt=v(Ot,2),ot=r(Vt),da=r(ot);i(ot),je(ot,e=>l(J,e),()=>t(J)),i(Vt);var Zt=v(Vt,2),lt=r(Zt);let we;var va=r(lt);f(va,{icon:"material-symbols:shuffle",class:"text-lg"}),i(lt);var pt=v(lt,2),fa=r(pt);f(fa,{icon:"material-symbols:skip-previous",class:"text-xl"}),i(pt);var ut=v(pt,2);let ke;var pa=r(ut);{var ma=e=>{f(e,{icon:"eos-icons:loading",class:"text-xl"})},ba=e=>{var m=nt(),_=tt(m);{var C=o=>{f(o,{icon:"material-symbols:pause",class:"text-xl"})},L=o=>{f(o,{icon:"material-symbols:play-arrow",class:"text-xl"})};z(_,o=>{t(x)?o(C):o(L,!1)},!0)}Y(e,m)};z(pa,e=>{t(u)?e(ma):e(ba,!1)})}i(ut);var mt=v(ut,2),ga=r(mt);f(ga,{icon:"material-symbols:skip-next",class:"text-xl"}),i(mt);var Lt=v(mt,2);let Ee;var ha=r(Lt);{var xa=e=>{f(e,{icon:"material-symbols:repeat-one",class:"text-lg"})},ya=e=>{var m=nt(),_=tt(m);{var C=o=>{f(o,{icon:"material-symbols:repeat",class:"text-lg"})},L=o=>{f(o,{icon:"material-symbols:repeat",class:"text-lg opacity-50"})};z(_,o=>{t(g)===2?o(C):o(L,!1)},!0)}Y(e,m)};z(ha,e=>{t(g)===1?e(xa):e(ya,!1)})}i(Lt),i(Zt);var Fe=v(Zt,2),Tt=r(Fe),_a=r(Tt);{var wa=e=>{f(e,{icon:"material-symbols:volume-off",class:"text-lg"})},ka=e=>{var m=nt(),_=tt(m);{var C=o=>{f(o,{icon:"material-symbols:volume-down",class:"text-lg"})},L=o=>{f(o,{icon:"material-symbols:volume-up",class:"text-lg"})};z(_,o=>{t(M)<.5?o(C):o(L,!1)},!0)}Y(e,m)};z(_a,e=>{t(S)||t(M)===0?e(wa):e(ka,!1)})}i(Tt);var it=v(Tt,2),Ea=r(it);i(it),je(it,e=>l(U,e),()=>t(U));var Mt=v(it,2);let Ae;var Fa=r(Mt);f(Fa,{icon:"material-symbols:queue-music",class:"text-lg"}),i(Mt),i(Fe),i(Ct);var Aa=v(Ct,2);{var Ca=e=>{var m=di(),_=r(m),C=r(_),L=r(C,!0);i(C);var o=v(C,2),H=r(o);f(H,{icon:"material-symbols:close",class:"text-lg"}),i(o),i(_);var ct=v(_,2);Va(ct,5,()=>t(p),Za,(bt,Q,q)=>{var G=ci();let St;var gt=r(G),Ba=r(gt);{var La=O=>{f(O,{icon:"material-symbols:graphic-eq",class:"text-[var(--primary)] animate-pulse"})},Ta=O=>{var Dt=nt(),te=tt(Dt);{var ee=dt=>{f(dt,{icon:"material-symbols:pause",class:"text-[var(--primary)]"})},ja=dt=>{var Me=ui();Me.textContent=q+1,Y(dt,Me)};z(te,dt=>{q===t(y)?dt(ee):dt(ja,!1)},!0)}Y(O,Dt)};z(Ba,O=>{q===t(y)&&t(x)?O(La):O(Ta,!1)})}i(gt);var Jt=v(gt,2),Ce=r(Jt);i(Jt);var Be=v(Jt,2),jt=r(Be);let Le;var Ma=r(jt,!0);i(jt);var Qt=v(jt,2);let Te;var Sa=r(Qt,!0);i(Qt),i(Be),i(G),Pt((O,Dt,te,ee)=>{St=N(G,1,"playlist-item flex items-center gap-3 p-3 hover:bg-[var(--btn-plain-bg-hover)] cursor-pointer transition-colors",null,St,O),rt(G,"aria-label",`播放 ${t(Q).title??""} - ${t(Q).artist??""}`),rt(Ce,"src",Dt),rt(Ce,"alt",t(Q).title),Le=N(jt,1,"font-medium truncate",null,Le,te),V(Ma,t(Q).title),Te=N(Qt,1,"text-sm text-[var(--content-meta)] truncate",null,Te,ee),V(Sa,t(Q).artist)},[()=>({"bg-[var(--btn-plain-bg)]":q===t(y),"text-[var(--primary)]":q===t(y)}),()=>kt(t(Q).cover),()=>({"text-[var(--primary)]":q===t(y),"text-90":q!==t(y)}),()=>({"text-[var(--primary)]":q===t(y)})]),h("click",G,()=>wt(q)),h("keydown",G,O=>{(O.key==="Enter"||O.key===" ")&&(O.preventDefault(),wt(q))}),Y(bt,G)}),i(ct),i(m),Pt(bt=>V(L,bt),[()=>Qa(Ja.playlist)]),h("click",o,ie),ri(3,m,()=>si,()=>({duration:300,axis:"y"})),Y(e,m)};z(Aa,e=>{t(b)&&e(Ca)})}i(ft),Ha(2),Pt((e,m,_,C,L,o,H,ct,bt,Q,q,G,St,gt)=>{Ft=N(ft,1,"music-player fixed bottom-4 right-4 z-50 transition-all duration-300 ease-in-out",null,Ft,e),ce=N(R,1,"orb-player w-12 h-12 bg-[var(--primary)] rounded-full shadow-lg cursor-pointer transition-all duration-500 ease-in-out flex items-center justify-center hover:scale-110 active:scale-95",null,ce,m),de=N(st,1,"mini-player card-base bg-[var(--float-panel-bg)] shadow-xl rounded-2xl p-3 transition-all duration-500 ease-in-out",null,de,_),rt(Wt,"src",C),fe=N(Wt,1,"w-full h-full object-cover transition-transform duration-300",null,fe,L),V(aa,t(I).title),V(ia,t(I).artist),ge=N(Ct,1,"expanded-player card-base bg-[var(--float-panel-bg)] shadow-xl rounded-2xl p-4 transition-all duration-500 ease-in-out",null,ge,o),rt(he,"src",H),xe=N(he,1,"w-full h-full object-cover transition-transform duration-300",null,xe,ct),V(sa,t(I).title),V(oa,t(I).artist),V(la,`${bt??""} / ${Q??""}`),rt(ot,"aria-valuenow",t(E)>0?t(P)/t(E)*100:0),Se(da,`width: ${t(E)>0?t(P)/t(E)*100:0}%`),we=N(lt,1,"w-10 h-10 rounded-lg",null,we,q),lt.disabled=t(p).length<=1,pt.disabled=t(p).length<=1,ke=N(ut,1,"btn-regular w-12 h-12 rounded-full",null,ke,G),ut.disabled=t(u),mt.disabled=t(p).length<=1,Ee=N(Lt,1,"w-10 h-10 rounded-lg",null,Ee,St),rt(it,"aria-valuenow",t(M)*100),Se(Ea,`width: ${t(M)*100}%`),Ae=N(Mt,1,"btn-plain w-8 h-8 rounded-lg",null,Ae,gt)},[()=>({expanded:t(B),"hidden-mode":t(d)}),()=>({"opacity-0":!t(d),"scale-0":!t(d),"pointer-events-none":!t(d)}),()=>({"opacity-0":t(B)||t(d),"scale-95":t(B)||t(d),"pointer-events-none":t(B)||t(d)}),()=>kt(t(I).cover),()=>({spinning:t(x)&&!t(u),"animate-pulse":t(u)}),()=>({"opacity-0":!t(B),"scale-95":!t(B),"pointer-events-none":!t(B)}),()=>kt(t(I).cover),()=>({spinning:t(x)&&!t(u),"animate-pulse":t(u)}),()=>le(t(P)),()=>le(t(E)),()=>({"btn-regular":t(j),"btn-plain":!t(j)}),()=>({"opacity-50":t(u)}),()=>({"btn-regular":t(g)>0,"btn-plain":t(g)===0}),()=>({"text-[var(--primary)]":t(b)})]),h("click",R,_t),h("keydown",R,e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),_t())}),h("click",At,Pe(_t)),h("click",qt,Pe(yt)),h("click",st,yt),h("keydown",st,e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),yt())}),h("click",Bt,_t),h("click",Gt,yt),h("click",ot,Ke),h("keydown",ot,e=>{if(e.key==="Enter"||e.key===" "){e.preventDefault(),t(J).getBoundingClientRect();const _=.5*t(E);t(a)&&(K(a,t(a).currentTime=_),l(P,_))}}),h("click",lt,Ne),h("click",pt,qe),h("click",ut,We),h("click",mt,$t),h("click",Lt,Ye),h("click",Tt,oe),h("click",it,Ue),h("keydown",it,e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),e.key==="Enter"&&oe())}),h("click",Mt,ie),Y(s,D)};z(He,s=>{s(Ge)})}Y(c,ue),Ua()}export{Ei as default};
